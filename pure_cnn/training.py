            ...
            if self.iter < self.train_num:
                ...
                while True:
                    if i < self.mini_batch_size and self.iter < self.train_num:
                        ...
                        # average_collected_gen_0 = (final_stats[0]['collected'] - initial_collected_gen_0) / self.iter
                        # average_collected_gen_1 = (final_stats[1]['collected'] - initial_collected_gen_1) / self.iter
                        # average_collected_gen_2 = (final_stats[2]['collected'] - initial_collected_gen_2) / self.iter
                        # average_collection_gen_0 = (final_stats[0]['collections'] - initial_collection_gen_0) / self.iter
                        # average_collection_gen_1 = (final_stats[1]['collections'] - initial_collection_gen_1) / self.iter
                        # average_collection_gen_2 = (final_stats[2]['collections'] - initial_collection_gen_2) / self.iter
                ...
                profiler.dump_stats("profiler_results_"+str(thresh)+"_collect.prof")
                final_stats = gc.get_stats()
